...
| 🔄 **[Room Reservation & Booking Flow](booking_and_reservation_flow.md)** | Full architectural analysis of the room reservation lifecycle with sequence diagrams, component classifications (Real vs. Simulated vs. Dummy), and PMS integration. | Complete Architecture & Audit |
